  ...
  const handleLogout = async () => {
    try {
      ...
      const res = await axios.post(
        "https://anantadi-task-backend.onrender.com/auth/logout",
        {},
        {
          headers: {
            Authorization: `${token}`,
    ...
    <>
      <div className="flex justify-between  items-center bg-purple-600 p-4 text-white px-28">
        <div className="flex items-center">
          <img
            className="w-10"
            src="https://images.scalebranding.com/letter-s-logo-39e9ee57-e28f-47ea-9085-9352cfc621dc.jpg"
            alt="logo"
          />
